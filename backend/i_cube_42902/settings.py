"""
Django settings for i_cube_42902 project.
...
ROOT_URLCONF = 'i_cube_42902.urls'
...
WSGI_APPLICATION = 'i_cube_42902.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "i_cube_42902 API",
    "DESCRIPTION": "API documentation for i_cube_42902 App",
    "VERSION": "v1",
}
